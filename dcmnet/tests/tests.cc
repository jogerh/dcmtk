...
OFTEST_REGISTER(dcmnet_ASC_requestAssociation_returns_DULC_TCPINITERROR_whenTimedOut);
OFTEST_REGISTER(dcmnet_ASC_requestAssociation_returns_DULC_TCPINITERROR_whenCanceled);
//#endif // WITH_THREADS
